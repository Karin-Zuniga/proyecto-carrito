...
#--------------cliente----------------------
  ...
  #TODO agregar rutas para disminuir, agregar y eliminar producto
    put 'pedidos/:id/productos/:id_producto', to: 'pedidos#aumentar_cantidad_productos', as: 'aumentar_producto_pedido'
